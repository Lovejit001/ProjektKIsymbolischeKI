...
from src.gamelogic.positions import get_all_pos
...
class TestPositions(unittest.TestCase):
    ...
    def test_starting_board_black(self):
        ...
        self.assertEqual(get_all_pos(starting_board, Black), expected)
